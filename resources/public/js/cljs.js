...
hello_clojurescript.get_audio_context = function() {
  try {
...
hello_clojurescript.play_sound = function() {
  var a = function(a) {
    var b = hello_clojurescript.get_audio_context.call(null);
    return(new BufferLoader(b, cljs.core.clj__GT_js.call(null, a), function(a) {
      return hello_clojurescript.process_buffers.call(null, a, b)
    })).load()
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
